...
export function Education(){
    const [ qualifications, setQualifications ] = useState({ id: "", degree: "", city: "", school: "", startDate: "", endDate: "" });
    const { degree, city, school, startDate, endDate  } = qualifications;
    const { detailState:{ education }, dispatchDetail } = useDetails();
    ...
    function submitEducation(){
        ...
        setQualifications({ id: "", degree: "", city: "", school: "", startDate: "", endDate: "" });
    }
    
    return(
        <div className="flex flex-col items-center justify-center mb-8 p-5 border-2 border-coolGray rounded shadow-xl">
            <h2 className="text-2xl font-bold text-center text-black mb-5">Education and Qualifications</h2>
                    ...
                    education?.map(({id, degree, startDate, endDate}) => {
                        return(
                            <div key={id} className="flex items-center justify-between my-2 px-5 py-2 border-2 border-coolGray rounded shadow">
                                ...
                                <button onClick={() => dispatchDetail({ type: "REMOVE_EDUCATION", payload: id })}>
                                    <ImCross/>
                                </button>
                            </div>
                        )
            ...
            <div className="w-full flex flex-col md:flex-row items-center justify-center">
                <div className="w-full flex flex-col m-4">
                    ...
                    <input className={inputStyle} 
                        value={degree}
                        type="text"
                        onChange={(e) => setQualifications(qualification => ({ ...qualification, degree: e.target.value, id: Math.random() }))}
                    />
                </div>
                ...
                <div className="w-full flex flex-col m-4">
                    ...
                    <input className={inputStyle} 
                        value={city}
                        type="text"
                        onChange={(e) => setQualifications(qualification => ({ ...qualification, city: e.target.value }))}
                    />
                </div>
            </div>
            ...
            <div className="w-full flex flex-col md:flex-row items-center justify-center">
                <div className="w-full flex flex-col m-4">
                    ...
                    <input className={inputStyle} 
                        value={school}
                        type="text"
                        onChange={(e) => setQualifications(qualification => ({ ...qualification, school: e.target.value }))}
                    />
                </div>
            </div>
            ...
            <div className="w-full flex flex-col md:flex-row items-center justify-center">
                <div className="w-full flex flex-col m-4">
                    ...
                    <input className={inputStyle}
                        ...
                        min="1960-01"
                        value={ startDate } 
                        onChange={(e) => setQualifications(qualification => ({ ...qualification, startDate: e.target.value }))}
                    />
                </div>
                ...
                <div className="w-full flex flex-col m-4">
                    ...
                    <input className={inputStyle}
                        ...
                        min="1960-01"
                        value={ endDate } 
                        onChange={(e) => setQualifications(qualification => ({ ...qualification, endDate: e.target.value }))}
                    />
                </div>
            </div>
