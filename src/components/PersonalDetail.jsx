...
export function PersonalDetail(){
    ...
    const { firstName, lastName, email, phone, address, pincode, city } = detailState;
            ...
            <div className="flex flex-col md:flex-row items-center justify-center">
                <div className="w-full flex flex-col m-4">
                    ...
                    <input className={inputClass} 
                        type="text"
                        value={ firstName }
                        onChange={(e) => dispatchDetail({ type:"ADD_FIRSTNAME", payload: e.target.value })}
                    />            
                </div>
                <div className="w-full flex flex-col">
                    ...
                    <input className={inputClass}
                        type="text"
                        value={ lastName }
                        onChange={(e) => dispatchDetail({ type:"ADD_LASTNAME", payload: e.target.value })}
                    />            
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center">
                <div className="w-full flex flex-col m-4">
                    ...
                    <input className={inputClass} 
                        type="email"
                        value={ email }
                        onChange={ (e) => dispatchDetail({ type:"ADD_EMAIL", payload: e.target.value }) }
                    />            
                </div>
                <div className="w-full flex flex-col">
                    ...
                    <input className={inputClass} 
                        type="tel"
                        value={ phone }
                        onChange={ (e) => dispatchDetail({ type:"ADD_PHONE", payload: e.target.value }) }
                    />            
                </div>
            </div>
            ...
            <div className="flex items-center justify-center">
                <div className="w-full flex flex-col md:ml-4 mt-4">
                    ...
                    <textarea className={inputClass} 
                        ...
                        cols="33"
                        value={ address }
                        onChange={ (e) => dispatchDetail({ type:"ADD_ADDRESS", payload: e.target.value }) }
                    >
                    </textarea>          
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center">
                <div className="w-full flex flex-col m-4">
                    ...
                    <input className={inputClass} 
                        type="text"
                        value={ pincode }
                        onChange={ (e) => dispatchDetail({ type:"ADD_PINCODE", payload: e.target.value }) }
                    />            
                </div>
                <div className="w-full flex flex-col">
                    ...
                    <input className={inputClass} 
                        type="text"
                        value={ city }
                        onChange={ (e) => dispatchDetail({ type:"ADD_CITY", payload: e.target.value }) }
                    />            
                </div>
            </div>
            <div className="md:ml-4 mt-8">
                <button className="w-full bg-primary text-white text-lg font-bold py-2 hover:bg-btn_hover rounded"
